						...
						<div class="panel panel-body">
							<div class="form-row">
								...
								<div class="form-group col-md-10">
   									...
   									{!! Form::button('<i class="fas fa-plus"></i> AGREGAR NOTA REMEDIAL', ['class' => 'btn btn-primary',  'id' => 'verNotas']) !!}
								</div>
								<div class="form-group col-md-2">

   									{!! Form::button('<i class="fas fa-clipboard"></i> VER PORCENTAJE REMEDIAL', ['class' => 'btn btn-primary',  'id' => 'porcentajeRemedial']) !!}
								</div>
