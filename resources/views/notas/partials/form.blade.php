                                                     ...
                                                     if(parcial == 3)
                                                        {
                                                         ...
                                                         setInterval(() => {
                                                              ...
                                                              var sumaTotalTodo = (((sumaTaTotal2) + (sumaTiTotal2) + (sumaTgTotal2) + (sumaLeTotal2) + (sumaEvTotal2)) / 5);
