            ...
            <div>
                ...
                <div>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="cedula" class="col-md-4 col-form-label text-md-right" style="color: white;">{{ __('Cedula') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right" style="color: white;">{{ __('Dirección E-Mail') }}</label>
...
<script>
    $('#cedula').on('change', function(){
        ...
        $.get('users/'+cedula, function(response){
