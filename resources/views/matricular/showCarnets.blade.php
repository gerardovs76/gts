            ...
            $.ajax({
                ...
                success: function(response)
                {
                   ...
                   // var carnet =document.getElementById("screenPrincipal");
                    ...
                    newWin.document.write('<div class="col-xs-12" id="screenPrincipal"><div id="carnet" class="center-block" style="height: 9.5cm; width: 6.5cm; background: url(images/imagen-carnet.jpg);"><img id="imagen-carnet" src="carnets/'+objeto.carnet+'" alt="" width="156px" height="156px" style="position: relative;left: 50px;top:107px; border-radius: 50%;"><ul style="position:relative;right:15px;top: 110px;font-size: 12px; font-weight: bold;list-style-type: none;">'+li+'</ul></div></div>');
