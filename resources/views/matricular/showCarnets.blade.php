            ...
            $.ajax({
                ...
                success: function(response)
                {
                   ...
                   // var carnet =document.getElementById("screenPrincipal");
                    ...
                    newWin.document.write('<style>@page{size:landscape; font-family:Roboto;font-size:4px; max-height:98%; max-width:100%;}html, body{height:98%;width:100%; -webkit-print-color-adjust: exact; background-image: url(images/imagen-carnet3.jpeg);background-repeat:no-repeat;no-repeat center center fixed;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;}</style><html><head><title></title>');
