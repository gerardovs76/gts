            ...
            $.ajax({
                ...
                success: function(response)
                {
                   ...
                   // var carnet =document.getElementById("screenPrincipal");
                    ...
                    newWin.document.write('<img id="imagen-carnet" src="carnets/'+objeto.carnet+'" alt="" width="640px" height="640px" style="position: relative;left: 260px;top:500px;border: 1px solid black; border-radius: 50%;"><ul style="position:relative;left:30px;top: 600px;font-size: 40px; font-weight: bold;list-style-type: none;">'+li+'</ul>');
