            ...
            $.ajax({
                ...
                success: function(response)
                {
                   ...
                   // var carnet =document.getElementById("screenPrincipal");
                    var li = '<li style="padding: 3px; color: #434B4D;">'+objeto.nombres+'&nbsp;&nbsp; '+objeto.curso+'<br>'+objeto.apellidos+'</li>';
                    ...
                    newWin.document.write('<div class="col-xs-12" id="screenPrincipal"><div id="carnet" class="center-block" style="border: 1px solid black; width: 6.5cm; height: 9.5cm;  background-image: url(images/imagen-carnet.jpeg);  background-repeat: no-repeat;  background-size: auto;><h6 style="position:relative;left:160px; top:30px;font-weight: bold;"><img id="imagen-carnet" src="carnets/'+objeto.carnet+'" alt="" width="150px" height="150px" style="position: relative;left: 46px;top:117px;border: 1px solid black; border-radius: 50%;"><ul style="position:relative;right:15px;top: 120px;font-size: 12px; font-weight: bold;list-style-type: none;">'+li+'</ul></div></div>');
