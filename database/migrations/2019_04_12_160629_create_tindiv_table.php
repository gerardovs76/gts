...
class CreateTindivTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tareas_individuales', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('tarea_individual');
    ...
    {
        Schema::dropIfExists('tareas_individuales');
    }
}
